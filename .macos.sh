# ~/.macos.sh https://github.com/kentcdodds/dotfiles/blob/main/.macos.sh
# Modified by Diogo Cardoso 
# Run without downloading:
# curl https://raw.githubusercontent.com/cardosod-ppb/dotfiles/HEAD/.macos.sh | bash
...
code --install-extension ms-vscode.vscode-speech-language-pack-pt-pt
...
sudo ln -sfn /opt/homebrew/opt/openjdk@17/libexec/openjdk.jdk /Library/Java/JavaVirtualMachines/openjdk-17.jdk # allow java wrappers to find JDK
export CPPFLAGS="-I/opt/homebrew/opt/openjdk@17/include" # allow compilers to find JDK

echo "configuring ruby"
brew install libyaml
export PATH="$HOME/.asdf/shims:$PATH" # override system ruby
